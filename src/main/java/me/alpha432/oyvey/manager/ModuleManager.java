...
import me.alpha432.oyvey.features.modules.combat.AutoSwapModule;
...
import me.alpha432.oyvey.features.modules.combat.TriggetbotModule;
...
import me.alpha432.oyvey.features.modules.movement.AutoSprintModule;
...
public class ModuleManager implements Jsonable, Util {
    ...
    public void init() {
        ...
        register(new AutoEZModule());
        register(new ChestStealerModule());
        register(new FlipModule());
        register(new SpearSwapModule());
