...
public class WatermarkHudModule extends HudModule {
    ...
    protected void render(Render2DEvent e) {
        ...
        net.minecraft.network.chat.MutableComponent component = TextUtil.text(watermarkString, text.getValue(), BuildConfig.VERSION);
        OyVey.fontManager.drawString(e.getContext(),
                component,
                getX(), getY(), -1);
