...
public class ColorButton extends Button {
    ...
    public void drawScreen(GuiGraphics context, int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.getName(), this.x + 2.3f, this.y - 1.7f - (float) OyVeyGui.getClickGui().getTextOffset(), -1, this.width - 9);
        ...
        if (open) {
            ...
            int buttonWidth = (pickerWidth - 1) / 2;
            float pasteX = pickerX + buttonWidth + 1;
            ...
            drawString("Copy", pickerX + buttonWidth / 2.0 - OyVey.fontManager.getStringWidth("Copy") / 2.0, this.y + yOffset + 3, -1);
            hoveringCopy = isHoveringArea(mouseX, mouseY, pickerX, this.y + yOffset, pickerX + buttonWidth, this.y + yOffset + 14);

            RenderUtil.rect(context, pasteX, this.y + yOffset, pickerX + pickerWidth, this.y + yOffset + 14,
                    hoveringPaste ? OyVey.colorManager.getColorWithAlpha(y, ClickGuiModule.getInstance().topColor.getValue().getAlpha()) : 0x11555555);
            drawString("Paste", pasteX + buttonWidth / 2.0 - OyVey.fontManager.getStringWidth("Paste") / 2.0 + 1, this.y + yOffset + 3, -1);
            hoveringPaste = isHoveringArea(mouseX, mouseY, pasteX, this.y + yOffset, pickerX + pickerWidth, this.y + yOffset + 14);
        }
    }
