...
public class Widget
    ...
    private void drag(int mouseX, int mouseY) {
        ...
        int newX = this.x2 + mouseX;
        int newY = this.y2 + mouseY;
    ...
    public int getTotalHeight() {
        return (int) (this.height + (this.open ? this.getTotalItemHeight() - 2.0f : 0.0f));
    }
    ...
    protected void drawString(String text, double x, double y, int color) {
        OyVey.fontManager.drawString(context, text, x, y, color);
    }
}