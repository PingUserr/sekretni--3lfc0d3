...
public class Slider
    ...
    public void drawScreen(GuiGraphics context, int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.getName() + " ", ChatFormatting.GRAY + (this.setting.getValue() instanceof Float ? this.setting.getValue().toString() : Double.valueOf((this.setting.getValue()).doubleValue()).toString()), this.x + 2.3f, this.y - 1.7f - (float) OyVeyGui.getClickGui().getTextOffset(), -1, -1);
    }
